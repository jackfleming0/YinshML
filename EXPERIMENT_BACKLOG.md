...
(Move completed experiments here with a one-paragraph result. Don't delete
their detailed write-ups above — those are durable knowledge for future
calibration.)

*(empty — populated as experiments resolve)*
